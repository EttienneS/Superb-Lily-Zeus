...
{
    var style = { font: "25px Consolas", fill: "#ffffff", align: "left" };
    var text = game.add.text(400, 100, 
        "Avoid the ghosts while trying to hit them with your axes.\n\n"+
        "Use WASD to move the character\n"+
        "Hold Left Click and move the mouse to swing your axes.\n"+
        "Alt to pause", style);
    text.anchor.set(0.5);

    var lifeStyle = { font: "35px Consolas", fill: "#ff00ff", align: "left" };
    lifeText = game.add.text(80, 350, "Life: 100", lifeStyle);
...
function showVictory()
{
    if (!gameOver)
    {
        var style = { font: "60px Consolas", fill: "#00ff44", align: "center" };
